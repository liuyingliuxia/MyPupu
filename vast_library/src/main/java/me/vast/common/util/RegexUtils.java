...
public class RegexUtils {
     ...
     * 验证Email
     *
     * @param email email地址，格式：zheng@gmail.com，zheng@xxx.com.cn，xxx代表邮件服务商
    ...
    public static boolean checkAlphabet(String alphabet) {
        ...
        String regex = "[^(A-Za-z)]";
        return Pattern.matches(regex, alphabet);
    }
     ...
     * @return
     */
    public static boolean checkChinesePlus(String alphabet) {
        if (TextUtils.isEmpty(alphabet)) {
            return false;
        }
...
//    }
    ...
    public static boolean checkURLPrefix(String url) {
        ...
        if (url.startsWith("http")) {   // 包含了HTTPS
            return true;
    ...
    public static boolean isHttpFormat(String url) {
        if (TextUtils.isEmpty(url)) {
            return false;
        }
        String str = "(http|ftp|https):\\/\\/([\\w.]+\\/?)\\S*";
        return Pattern.compile(str).matcher(url).matches();
    }

    public static boolean isMobile(String str) {// 简单判断手机号码
        if (TextUtils.isEmpty(str)) {
            return false;
        }
    ...
    public static boolean checkPhoneAddMobile(String str) { // 简单判断手机号码 电话号码
        if (TextUtils.isEmpty(str)) {
            return false;
        }
    ...
    public static boolean isNumeric(String str) { // 全数字
        if (TextUtils.isEmpty(str)) {
            return false;
        }
    ...
    public static boolean isAscCode0to127(String str){
        if (TextUtils.isEmpty(str)) {
            return false;
        }

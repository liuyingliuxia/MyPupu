...
import me.vast.common.widgets.stickyheader.caching.HeaderProvider;
import me.vast.common.widgets.stickyheader.caching.HeaderViewCache;
import me.vast.common.widgets.stickyheader.calculation.DimensionCalculator;
import me.vast.common.widgets.stickyheader.rendering.HeaderRenderer;
import me.vast.common.widgets.stickyheader.util.LinearLayoutOrientationProvider;
import me.vast.common.widgets.stickyheader.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
  ...
  public Rect findHeaderPositionUnderRect(int x, int y) {
    for (int i = 0; i < mHeaderRects.size(); i++) {
      Rect rect = mHeaderRects.get(mHeaderRects.keyAt(i));
      if (rect.contains(x, y)) {
        return rect;

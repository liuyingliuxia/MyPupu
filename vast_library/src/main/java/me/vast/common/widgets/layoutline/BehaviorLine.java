package me.vast.common.widgets.layoutline;
...
public class BehaviorLine {
    ...
    public void updateLineColor(int lineGravity, float size, @ColorInt int lineColor) {
        ...
        if ((lineGravity & LEFT) != 0) {
            if (null != leftLine) {
                ...
                if (lineColor != 0 && leftLine.paint.getColor() != lineColor) {
        ...
        if ((lineGravity & TOP) != 0) {
            if (null != topLine) {
                ...
                if (lineColor != 0 && topLine.paint.getColor() != lineColor) {
        ...
        if ((lineGravity & RIGHT) != 0) {
            if (null != rightLine) {
                ...
                if (lineColor != 0 && rightLine.paint.getColor() != lineColor) {
        ...
        if ((lineGravity & BOTTOM) != 0) {
            if (null != bottomLine) {
                ...
                if (lineColor != 0 && bottomLine.paint.getColor() != lineColor) {

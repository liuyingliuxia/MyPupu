...
/**
 * Created by zhengz on 2017/12/15.
 */
...
public class RoundFrameLayout2 extends FrameLayout {
    ...
    public RoundFrameLayout2(Context context) {
        this(context, null);
    }

    public RoundFrameLayout2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundFrameLayout2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundFrameLayoutMode);
            float radius = ta.getDimension(R.styleable.RoundFrameLayoutMode_radius_, 0);
            topLeftRadius = ta.getDimension(R.styleable.RoundFrameLayoutMode_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundFrameLayoutMode_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundFrameLayoutMode_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundFrameLayoutMode_bottomRightRadius, radius);
            ta.recycle();
        }

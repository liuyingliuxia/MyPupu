...
public class DashView extends View {
    private final int DEFAULT_DASH_WIDTH = 100;
    private final int DEFAULT_LINE_WIDTH = 100;
    private final int DEFAULT_LINE_HEIGHT = 10;
    private final int DEFAULT_LINE_COLOR = 0x9E9E9E;
     ...
     * 默认为水平方向
     */
    private final int DEFAULT_DASH_ORIENTATION = ORIENTATION_HORIZONTAL;
    /**
     * 间距宽度
     */

package me.vast.common.widgets.materialishprogress;
...
public class ProgressWheel extends View {
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs,
                me.vast.common.R.styleable.ProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(me.vast.common.R.styleable.ProgressWheel_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(me.vast.common.R.styleable.ProgressWheel_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(me.vast.common.R.styleable.ProgressWheel_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(me.vast.common.R.styleable.ProgressWheel_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(me.vast.common.R.styleable.ProgressWheel_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(me.vast.common.R.styleable.ProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(me.vast.common.R.styleable.ProgressWheel_matProg_barColor, barColor);

        rimColor = a.getColor(me.vast.common.R.styleable.ProgressWheel_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(me.vast.common.R.styleable.ProgressWheel_matProg_linearProgress, false);

        if (a.getBoolean(me.vast.common.R.styleable.ProgressWheel_matProg_progressIndeterminate, false)) {
            spin();
        }

...
public class SaveHistory {
    private final static String PREFERENCE_NAME = " ";
    private final static String SEARCH_HISTORY=" ";
    // 保存搜索记录
    public static void saveSearchHistory(String inputText,Context context) {
        ...
        ArrayList<String> historyList = new ArrayList<String>(Arrays.asList(tmpHistory)); //将改数组转换成ArrayList
    ...
    public static List<String> getSearchHistory(Context context){
        ...
        ArrayList<String> historyList = new ArrayList<String>(Arrays.asList(tmpHistory));
